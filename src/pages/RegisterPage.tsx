...
import { Mail, Lock, User, Sprout, ArrowRight, Chrome } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#28282B] flex items-center justify-center px-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-[#f4d03f]/3 rounded-full blur-3xl" />
      </div>
      ...
      >
        ...
        >
          ...
          <p className="text-white/50 text-sm">Join Earthworm and start farming smarter</p>
        </motion.div>
